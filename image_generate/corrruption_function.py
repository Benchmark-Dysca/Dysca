...
def parse_args():
    parser = argparse.ArgumentParser(
        prog='Dysca Benchmark Corruption Generator',
        description='A script for generating corruption images of Dysca Benchmark')
    parser.add_argument('--input_folder', default='./Dysca', help="The input image folder")  
    parser.add_argument('--output_folder', default='./Dysca_corruption', help="The output image folder") 
...
if __name__ == '__main__': 
    ...
    corruption(image_path,output_path,state='random')